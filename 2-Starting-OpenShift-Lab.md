...
As you can see on the picture, you will connect to the OpenShift Cluster Web UI to the Master nodes for management and development purposes. The end-users will connect to the applications thru the Nodes.
...
To get access to the OpenShift Console, first connect to **IBM Cloud with the credentials**. 
...
This link is very practical to download the **oc** command line.
